    ...
    async eventListener() {
        this.btnNxt?.addEventListener("click",
            () => {
                ...
                this.nextSlide(this.carouselCtn?.children, this.carouselCtn.childElementCount -1);
            });
        
        this.btnPrev?.addEventListener("click",
            () => {
                if(this.awaitScroll || !this.carouselCtn) return;
                this.prevSlide(this.carouselCtn.children, this.carouselCtn.childElementCount -1)
            });
    }
